...
import 'swiper/css';
import './HSwiperStyles.css'


export default function HFooterslider() {
  ...
  return (
    ...
    >
      <SwiperSlide>
      <div className='h-fbcard'>
                    <span className='h-quote'><img src='images/quote.png' alt='quote'></img></span>
                    <p>{infos[0].feedback}</p>
                <div className='h-fbcardline'></div>
                <div className='h-fbdetail'>
                    <div className='h-avatar'><img src='images/ava1.png' alt='avatar'></img></div>
                    <p>{infos[0].name}</p>
                    <span className='h-stars'><img src='images/stars.png' alt='stars'></img></span>
                </div>    
                </div>
      </SwiperSlide>
      <SwiperSlide>
      <div className='h-fbcard' >
                ...
                <div className='h-fbcardline'></div>
                <div className='h-fbdetail'>
                    <div className='h-avatar'><img src='images/ava2.png' alt='avatar'></img></div>
                    <p>{infos[1].name}</p>
                    <span className='h-stars'><img src='images/stars.png' alt='stars'></img></span>
                </div>    
                </div>
